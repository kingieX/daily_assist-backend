...
- If you get `"Captcha token is required"`, either:
  1. set/pass `CAPTCHA_TOKEN` from your frontend captcha widget, or
  2. temporarily unset `CAPTCHA_SECRET` in local backend `.env` while smoke testing.
