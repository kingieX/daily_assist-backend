...
export const visitPaths: OpenAPIV3.PathsObject = {
  ...
  '/staff/alerts': {
    get: {
      ...
      description: 'Returns alerts from the shared notifications table for the authenticated staff member. Reminder, visit-status, and message alerts should be generated by the same worker-driven pipeline used by admin dashboard alerts rather than computed ad hoc on read.',
      security: staffSecurity,
